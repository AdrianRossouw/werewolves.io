...
~~~sh
# getting the code
git clone git@github.com:nko4/nodesque.git && cd ./nodesque/

# developing
npm install
npm start

# deploying (to http://nodesque.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@nodesque.2013.nodeknockout.com
ssh root@nodesque.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@nodesque.2013.nodeknockout.com
ssh -i ./id_deploy root@nodesque.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/nodesque" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
